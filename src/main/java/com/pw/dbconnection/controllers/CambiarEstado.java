...
public class CambiarEstado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idNoticiaStrign = request.getParameter("idNoticia");
        Integer idNoticia = Integer.parseInt(idNoticiaStrign);
        switch(acc){
            case "aceptado":{
                try {
                    NoticiaDAO.UpdateStatus(idNoticia, 2, null);
                    break;
            ...
            case "denegado":{
                try {
                    ...
                    NoticiaDAO.UpdateStatus(idNoticia, 3, motivo);
                    break;
                } catch (SQLException ex) {
                    Logger.getLogger(CambiarEstado.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        response.sendRedirect(request.getContextPath() + "/Edicion");
    }
