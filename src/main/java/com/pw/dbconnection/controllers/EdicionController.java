...
public class EdicionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<NoticiasModel> noticias = NoticiaDAO.GetNoticias();
            ...
            Logger.getLogger(EdicionController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
